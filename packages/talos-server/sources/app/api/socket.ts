...
export function startSocket(app: Fastify) {
    ...
    io.use(async (socket, next) => {
        ...
        socket.data.talosClient = socket.handshake.auth.talosClient as string
            || socket.handshake.headers['x-talos-client'] as string
            || undefined;
        next();
    });
    ...
    io.on("connection", (socket) => {
        ...
        const talosClient = socket.data.talosClient as string | undefined;

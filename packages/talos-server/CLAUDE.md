...
This document contains the development guidelines and instructions for the Talos Server project. This guide OVERRIDES any default behaviors and MUST be followed exactly.

## Project Overview

**Name**: talos-server\
**Repository**: the configured Talos monorepo\
**License**: MIT\
**Language**: TypeScript\
**Runtime**: Node.js 20\
...
- **Tell**: Wrong server URL = check `TALOS_SERVER_URL` env var
- **Tell**: Wrong home dir = check `TALOS_HOME_DIR` (should be `~/.talos-dev` for local)

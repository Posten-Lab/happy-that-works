...
export const SettingsSchema = z.object({
    ...
    workflowLibraryV3: WorkflowLibrarySchema,
    workflowLibraryV4: WorkflowLibrarySchema,
    workflowLibraryV2: WorkflowLibrarySchema.refine(items => items.every(item => !!item.steps), 'Editable workflows require steps.'),
    expAgentLibrary: z.boolean(),
    agentLibrary: AgentLibrarySchema,
    agentLibraryV2: AgentLibrarySchema,
    agentLibraryV3: AgentLibrarySchema,

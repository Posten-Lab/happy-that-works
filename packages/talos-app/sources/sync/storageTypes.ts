...
export const MetadataSchema = z.preprocess(normalizeMetadata, z.object({
    ...
    talosHomeDir: z.string().optional(), // Talos configuration directory
     ...
     * `parentSessionId` is the Talos session this one was branched from.
...
export const MachineMetadataSchema = z.preprocess(normalizeMetadata, z.object({
    host: z.string(),
    platform: z.string(),
    talosCliVersion: z.string(),
    talosHomeDir: z.string(), // Directory for Talos auth, settings, logs (usually .talos/ or .talos-dev/)
    ...
    shutdownSource: z.enum(['talos-app', 'talos-cli', 'os-signal', 'unknown']).optional(),
    ...
    resumeSupport: z.object({
        ...
        requiresTalosAgentAuth: z.boolean(),
        talosAgentAuthenticated: z.boolean(),
        detectedAt: z.number(),
    }).optional(),
}));

...
export const HomeHeaderNotAuth = React.memo(() => {
    ...
    return (
        <Header
            title={<HeaderTitleWithSubtitle showStatus={false} subtitle={serverInfo.isCustom ? serverInfo.hostname + (serverInfo.port ? `:${serverInfo.port}` : '') : undefined} />}
...
function HeaderTitleWithSubtitle({ subtitle, showStatus = true }: { subtitle?: string; showStatus?: boolean }) {
    ...
    const showConnectionStatus = showStatus && !hasCustomSubtitle && connectionStatus.text;

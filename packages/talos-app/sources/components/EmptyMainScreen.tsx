...
export function EmptyMainScreen() {
    ...
    return (
        <View style={styles.container}>
            <View style={{ marginBottom: 28 }}><TalosBrand size={48} /></View>
            {/* Terminal-style code block */}
            <Text style={styles.title}>{t('components.emptyMainScreen.readyToCode')}</Text>
            <View style={styles.terminalBlock}>
                {brand.installCommand && (
                    <Text style={[styles.terminalText, styles.terminalTextFirst]}>$ {brand.installCommand}</Text>
                )}

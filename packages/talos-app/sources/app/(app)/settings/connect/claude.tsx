...
export default function ClaudeOAuth() {
    ...
    return (
        <>
            <OAuthViewUnsupported name="Claude" command="talos connect claude" />
            {/* <OAuthView
                name="Claude"
                command="talos connect claude"
...
const OAuthViewUnsupported = React.memo((props: {
    ...
    const command = props.command || `talos connect ${props.name.toLowerCase()}`;

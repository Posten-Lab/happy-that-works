...
import { talosPalette } from './brand';
...
export const lightTheme = {
    dark: false,
    colors: {
        accent: talosPalette.light.accent,
        accentSoft: talosPalette.light.accentSoft,

        //
        // Main colors
        //

        text: talosPalette.light.text,
        textDestructive: Platform.select({ ios: '#FF3B30', default: '#F44336' }),
        textSecondary: talosPalette.light.secondary,
        textLink: talosPalette.light.accent,
        deleteAction: '#FF6B6B', // Delete/remove button color
        warningCritical: '#FF3B30',
        warning: '#8E8E93',
        success: '#34C759',
        surface: talosPalette.light.surface,
        surfaceRipple: 'rgba(0, 0, 0, 0.08)',
        surfacePressed: talosPalette.light.raised,
        surfaceSelected: talosPalette.light.accentSoft,
        surfacePressedOverlay: Platform.select({ ios: '#D1D1D6', default: 'transparent' }),
        surfaceHigh: talosPalette.light.raised,
        surfaceHighest: talosPalette.light.raised,
        divider: talosPalette.light.border,
        shadow: {
        ...
        groupped: {
            background: talosPalette.light.background,
            chevron: Platform.select({ ios: '#C7C7CC', default: '#49454F' }),
            sectionTitle: Platform.select({ ios: '#8E8E93', default: '#49454F' }),
        },
        header: {
            background: talosPalette.light.surface,
            tint: '#18171C'
        },
        switch: {
            track: {
                active: talosPalette.light.accent,
                inactive: '#dddddd',
            },
            thumb: {
                active: '#FFFFFF',
        ...
        fab: {
            background: talosPalette.light.accent,
            backgroundPressed: talosPalette.light.accent,
            icon: talosPalette.light.onAccent,
        },
        radio: {
            active: talosPalette.light.accent,
            inactive: '#C0C0C0',
            dot: talosPalette.light.accent,
        },
        modal: {
        ...
        button: {
            primary: {
                background: talosPalette.light.accent,
                tint: talosPalette.light.onAccent,
                disabled: '#C0C0C0',
            },
            secondary: {
                tint: '#666666',
        ...
        input: {
            background: talosPalette.light.raised,
            text: '#000000',
            placeholder: '#999999',
        },
        box: {
        ...
        // Message View colors
        userMessageBackground: talosPalette.light.accentSoft,
...
export const darkTheme = {
    dark: true,
    colors: {
        accent: talosPalette.dark.accent,
        accentSoft: talosPalette.dark.accentSoft,

        //
        // Main colors
        //

        text: talosPalette.dark.text,
        textDestructive: Platform.select({ ios: '#FF453A', default: '#F48FB1' }),
        textSecondary: talosPalette.dark.secondary,
        textLink: talosPalette.dark.accent,
        deleteAction: '#FF6B6B', // Delete/remove button color (same in both themes)
        warningCritical: '#FF453A',
        warning: '#8E8E93',
        success: '#32D74B',
        surface: talosPalette.dark.surface,
        surfaceRipple: 'rgba(255, 255, 255, 0.08)',
        surfacePressed: talosPalette.dark.raised,
        surfaceSelected: talosPalette.dark.accentSoft,
        ...
        surfaceHigh: talosPalette.dark.raised,
        surfaceHighest: talosPalette.dark.raised,
        divider: talosPalette.dark.border,
        shadow: {
            color: Platform.select({ default: '#000000', web: 'rgba(0, 0, 0, 0.1)' }),
            opacity: 0.1,
        },
        ...
        header: {
            background: talosPalette.dark.surface,
            tint: '#ffffff'
        },
        switch: {
            track: {
                active: talosPalette.dark.accent,
                inactive: '#3a393f',
            },
            thumb: {
                active: '#FFFFFF',
        ...
        groupped: {
            background: talosPalette.dark.background,
            chevron: Platform.select({ ios: '#48484A', default: '#CAC4D0' }),
            sectionTitle: Platform.select({ ios: '#8E8E93', default: '#CAC4D0' }),
        },
        fab: {
            background: talosPalette.dark.accent,
            backgroundPressed: talosPalette.dark.accent,
            icon: talosPalette.dark.onAccent,
        },
        radio: {
            active: talosPalette.dark.accent,
            inactive: '#48484A',
            dot: talosPalette.dark.accent,
        },
        modal: {
        ...
        button: {
            primary: {
                background: talosPalette.dark.accent,
                tint: talosPalette.dark.onAccent,
                disabled: '#C0C0C0',
            },
            secondary: {
                tint: '#8E8E93',
        ...
        input: {
            background: talosPalette.dark.raised,
            text: '#FFFFFF',
            placeholder: '#8E8E93',
        },
        box: {
        ...
        // Message View colors
        userMessageBackground: talosPalette.dark.accentSoft,

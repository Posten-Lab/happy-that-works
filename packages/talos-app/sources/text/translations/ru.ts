...
/**
 * Russian translations for the Talos app
...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'О программе',
        aboutFooter: 'Talos — мобильное приложение для работы с Codex и Claude Code. Использует сквозное шифрование, все данные аккаунта хранятся только на вашем устройстве. Не связано с Anthropic.',
        whatsNew: 'Что нового',
    ...
    errors: {
        ...
        voiceConversationLimitReached: "Вы достигли лимита голосовых разговоров за этот месяц.",
    ...
    server: {
        ...
        notValidTalosServer: 'Это не валидный сервер Talos',
    ...
    sessionInfo: {
        ...
        talosSessionIdCopied: 'ID сессии Talos скопирован в буфер обмена',
        failedToCopySessionId: 'Не удалось скопировать ID сессии Talos',
        talosSessionId: 'ID сессии Talos',
        ...
        talosHome: 'Домашний каталог Talos',
        ...
        updateCliInstructions: "Обновите Talos из того же источника, из которого вы его установили.",
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Установите Talos CLI',
            runIt: 'Запустите его',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Используйте собственного агента ElevenLabs вместо стандартного Talos. Подписка не требуется — подключайтесь напрямую через свой аккаунт ElevenLabs. Ваш агент должен определить два клиентских инструмента: messageClaudeCode (отправляет текст агенту кодирования) и processPermissionRequest (разрешает или запрещает использование инструментов). Контекст сессии передаётся через динамическую переменную {{initialConversationContext}}.',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: 'Не настроено',
        customAgentIdDescription: 'Введите ваш ElevenLabs Agent ID. Оставьте пустым, чтобы использовать стандартный Talos.',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: 'Прямое подключение',
        bypassTokenSubtitle: 'Пропустить сервер Talos, подключиться напрямую к ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Терминал запрашивает подключение к вашему аккаунту Talos. Это позволит терминалу безопасно отправлять и получать сообщения.',
    ...
    imageUpload: {
        ...
        uploadFailedMessage: ({ count }: { count: number }) => count === 1
            ? `Не удалось загрузить одно вложение. Сообщение и вложения сохранены здесь. Нажмите «Отправить», чтобы повторить.`
            : `Не удалось загрузить вложения (${count}). Сообщение и вложения сохранены здесь. Нажмите «Отправить», чтобы повторить.`,
        sendFailedMessage: `Не удалось отправить сообщение. Черновик сохранён здесь. Попробуйте ещё раз.`,

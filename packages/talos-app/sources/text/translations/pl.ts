...
/**
 * Polish translations for the Talos app
...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Talos to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
    ...
    errors: {
        ...
        voiceConversationLimitReached: "Osiągnięto miesięczny limit rozmów głosowych.",
    ...
    server: {
        ...
        notValidTalosServer: 'To nie jest prawidłowy serwer Talos',
    ...
    sessionInfo: {
        ...
        talosSessionIdCopied: 'ID sesji Talos skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji Talos',
        talosSessionId: 'ID sesji Talos',
        ...
        talosHome: 'Katalog domowy Talos',
        ...
        updateCliInstructions: "Zaktualizuj Talos z tego samego źródła, z którego go zainstalowano.",
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Zainstaluj Talos CLI',
            runIt: 'Uruchom je',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Talos. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    imageUpload: {
        ...
        uploadFailedMessage: ({ count }: { count: number }) => count === 1
            ? `Nie udało się przesłać jednego załącznika. Wiadomość i załączniki pozostały tutaj. Naciśnij Wyślij, aby spróbować ponownie.`
            : `Nie udało się przesłać załączników (${count}). Wiadomość i załączniki pozostały tutaj. Naciśnij Wyślij, aby spróbować ponownie.`,
        sendFailedMessage: `Nie udało się wysłać wiadomości. Szkic pozostał tutaj. Spróbuj ponownie.`,

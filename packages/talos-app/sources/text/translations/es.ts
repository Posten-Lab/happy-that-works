...
/**
 * Spanish translations for the Talos app
...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Talos es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    errors: {
        ...
        voiceConversationLimitReached: "Has alcanzado el límite de conversaciones de voz de este mes.",
    ...
    server: {
        ...
        notValidTalosServer: 'No es un servidor Talos válido',
    ...
    sessionInfo: {
        ...
        talosSessionIdCopied: 'ID de sesión de Talos copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de Talos',
        talosSessionId: 'ID de sesión de Talos',
        ...
        updateCliInstructions: "Actualiza Talos desde la misma distribución que instalaste.",
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale el Talos CLI',
            runIt: 'Ejecútelo',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Talos. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
    ...
    imageUpload: {
        ...
        uploadFailedMessage: ({ count }: { count: number }) => count === 1
            ? `No se pudo subir un archivo adjunto. Tu mensaje y los archivos siguen aquí. Pulsa Enviar para reintentar.`
            : `No se pudieron subir ${count} archivos adjuntos. Tu mensaje y los archivos siguen aquí. Pulsa Enviar para reintentar.`,
        sendFailedMessage: `No se pudo enviar el mensaje. Tu borrador sigue aquí. Inténtalo de nuevo.`,

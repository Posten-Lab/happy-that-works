...
/**
 * Italian translations for the Talos app
...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Talos è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
    ...
    errors: {
        ...
        voiceConversationLimitReached: "Hai raggiunto il limite di conversazioni vocali per questo mese.",
    ...
    server: {
        ...
        notValidTalosServer: 'Non è un Talos Server valido',
    ...
    sessionInfo: {
        ...
        talosSessionIdCopied: 'ID sessione Talos copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione Talos',
        talosSessionId: 'ID sessione Talos',
        ...
        updateCliInstructions: "Aggiorna Talos dalla stessa distribuzione utilizzata per l’installazione.",
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Installa la CLI Talos',
            runIt: 'Avviala',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account Talos. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',

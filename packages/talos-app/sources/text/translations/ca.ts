...
/**
 * Catalan translations for the Talos app
...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Talos és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    errors: {
        ...
        voiceConversationLimitReached: "Has arribat al límit de converses de veu d’aquest mes.",
    ...
    server: {
        ...
        notValidTalosServer: 'No és un servidor Talos vàlid',
    ...
    sessionInfo: {
        ...
        talosSessionIdCopied: 'ID de la sessió de Talos copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Talos',
        talosSessionId: 'ID de la sessió de Talos',
        ...
        updateCliInstructions: "Actualitza Talos des de la mateixa distribució que has instal·lat.",
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instal·la el Talos CLI',
            runIt: 'Executa\'l',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de Talos. Això permetrà al terminal enviar i rebre missatges de forma segura.',
    ...
    imageUpload: {
        ...
        uploadFailedMessage: ({ count }: { count: number }) => count === 1
            ? `No s’ha pogut pujar un fitxer adjunt. El missatge i els fitxers continuen aquí. Prem Envia per tornar-ho a provar.`
            : `No s’han pogut pujar ${count} fitxers adjunts. El missatge i els fitxers continuen aquí. Prem Envia per tornar-ho a provar.`,
        sendFailedMessage: `No s’ha pogut enviar el missatge. L’esborrany continua aquí. Torna-ho a provar.`,

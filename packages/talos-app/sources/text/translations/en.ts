...
export const en: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Talos is a Codex and Claude Code mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
    ...
    errors: {
        ...
        voiceConversationLimitReached: "You have reached your voice conversation limit for this month.",
    ...
    server: {
        ...
        notValidTalosServer: 'Not a valid Talos Server',
    ...
    sessionInfo: {
        ...
        talosSessionIdCopied: 'Talos Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Talos Session ID',
        talosSessionId: 'Talos Session ID',
        ...
        resumeSessionNeedsTalosAgent: 'Resume is unavailable on this machine. Run `talos-agent auth login` to enable it.',
        ...
        updateCliInstructions: "Update Talos using the same distribution you installed.",
    ...
    components: {
        emptyMainScreen: {
            ...
            readyToCode: 'Connect your first terminal',
            installCli: 'Install the Talos CLI',
            runIt: 'Run it',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Use your own ElevenLabs agent instead of the Talos default. No subscription required — connect directly with your own ElevenLabs account. Your agent must define two client tools: messageClaudeCode (sends text to the coding agent) and processPermissionRequest (allows or denies tool use). It receives session context via the {{initialConversationContext}} dynamic variable.',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: 'Not configured',
        customAgentIdDescription: 'Enter your ElevenLabs agent ID. Leave empty to use the Talos default.',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: 'Direct Connection',
        bypassTokenSubtitle: 'Skip Talos server, connect straight to ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Talos account. This will allow the terminal to send and receive messages securely.',
    ...
    welcome: {
        ...
        title: 'Your agents. Your command.',
        ...
        loginWithMobileApp: 'Log in with mobile app',
    },
    ...
    workflowWorkspace: {
        ...
        cancelMessage: ({ isolated }: { isolated: boolean }) => isolated ? 'Active work will stop. The isolated worktree, decisions, and evidence are retained.' : 'Active work will stop. This directory, decisions, and evidence are retained.',

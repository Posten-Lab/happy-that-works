...
/**
 * Portuguese (Brazilian) translations for the Talos app
...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Talos é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    errors: {
        ...
        voiceConversationLimitReached: "Você atingiu o limite de conversas de voz deste mês.",
    ...
    server: {
        ...
        notValidTalosServer: 'Não é um servidor Talos válido',
    ...
    sessionInfo: {
        ...
        talosSessionIdCopied: 'ID da sessão Talos copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão Talos',
        talosSessionId: 'ID da sessão Talos',
        ...
        updateCliInstructions: "Atualize o Talos pela mesma distribuição usada na instalação.",
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale o Talos CLI',
            runIt: 'Execute',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Talos. Isso permitirá que o terminal envie e receba mensagens com segurança.',

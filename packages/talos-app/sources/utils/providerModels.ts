...
export function mergeProviderModels(
    catalogs: readonly ProviderModel[][],
): ProviderModel[] {
    ...
    for (const catalog of catalogs) {
        for (const model of catalog) {
            ...
            merged.set(model.code, {
                ...
                supportedReasoningEfforts: efforts.size > 0 ? [...efforts.values()] : existing.supportedReasoningEfforts ?? model.supportedReasoningEfforts,
            });
        }
    }

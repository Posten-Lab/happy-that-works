...
export function showMicrophonePermissionDeniedAlert(canAskAgain: boolean = false) {
  ...
  const message = canAskAgain
    ? 'Talos needs access to your microphone for voice chat. Please grant permission when prompted.'
    : 'Talos needs access to your microphone for voice chat. Please enable microphone access in your device settings.';

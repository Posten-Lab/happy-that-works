...
export const DaemonPrompt: React.FC<DaemonPromptProps> = ({ onSelect }) => {
    ...
    return (
        <Box flexDirection="column">
            <Box marginBottom={1}>
                <Text bold color="cyan">🚀 Talos Daemon Setup</Text>
            </Box>
            
            <Box flexDirection="column" marginBottom={1}>
                <Text>📱 Talos can run a background service that allows you to:</Text>
            ...
            <Box marginBottom={1}>
                <Text>Would you like Talos to start this service automatically?</Text>
            </Box>

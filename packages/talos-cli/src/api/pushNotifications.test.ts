...
function makeMetadata(overrides: Partial<Metadata> = {}): Metadata {
    return {
        path: '/Users/test/projects/talos',
        host: 'test-host',
        homeDir: '/Users/test',
        talosHomeDir: '/Users/test/.talos',
        talosLibDir: '/Users/test/.talos/lib',
        talosToolsDir: '/Users/test/.talos/tools',
        ...overrides,
    };
}
...
describe('getSessionNotificationBody', () => {
    ...
    it('falls back to the last path segment', () => {
        const metadata = makeMetadata({
            path: '/Users/test/projects/talos-cli',
        });

        expect(getSessionNotificationBody(metadata)).toBe('talos-cli');
    });

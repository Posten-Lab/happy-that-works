 ...
 */
export type BackendFlavor = 'claude' | 'codex' | 'gemini' | 'opencode' | 'openclaw' | 'muse' | 'acp';
...
export interface CreateSessionMetadataOptions {
    ...
    /** Talos session id this session was forked from. */
    parentSessionId?: string;
    /** Talos message id used as the fork rewind point. */

...
describe('buildCodexTurnPrompt', () => {
    it('prepends Talos append system prompt before the first Codex user message', () => {
    ...
    it('does not inject Talos preamble on normal follow-up turns', () => {
        const prompt = buildCodexTurnPrompt({
            message: 'continue',
            mode: {
                appendSystemPrompt: '<options><option>Yes</option></options>',
    ...
    it('can re-inject Talos append prompt without title instruction after a thread reset', () => {
        const prompt = buildCodexTurnPrompt({
            message: 'start fresh',
            mode: {
                appendSystemPrompt: '<options><option>Yes</option></options>',

...
- `packages/talos-cli/src/codex/codex.integration.test.ts`
- `packages/talos-cli/src/claude/claude.integration.test.ts`
- `packages/talos-cli/src/gemini/gemini.integration.test.ts`
- `packages/talos-cli/src/openclaw/openclaw.integration.test.ts`

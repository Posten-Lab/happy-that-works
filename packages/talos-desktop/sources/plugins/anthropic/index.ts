...
const STORAGE_KEY = 'talos.plugin.anthropic.apiKey'

const MODELS: ModelDescriptor[] = [
    { id: 'claude-fable-5',    label: 'Fable 5',    group: 'Anthropic', description: 'Most capable — new tier above Opus.' },
    { id: 'claude-opus-5',     label: 'Opus 5',     group: 'Anthropic', description: 'Latest Opus generation.' },
    { id: 'claude-opus-4-8',   label: 'Opus 4.8',   group: 'Anthropic', description: 'Previous Opus generation.' },

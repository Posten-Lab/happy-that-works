...
export const TALOS_LIGHT_DEFAULT: ChromeTheme = {
    ...CODEX_LIGHT_DEFAULT,
    accent: '#80551e', ink: '#25231f', surface: '#f4f1ea', opaqueWindows: true,
}

export const TALOS_DARK_DEFAULT: ChromeTheme = {
    ...CODEX_DARK_DEFAULT,
    accent: '#d9ae68', ink: '#f2eee5', surface: '#141413', opaqueWindows: true,
}
...
export const BUILTIN_THEMES: ThemeEntry[] = (() => {
    ...
    push({ codeThemeId: 'talos', variant: 'light', theme: TALOS_LIGHT_DEFAULT })
    push({ codeThemeId: 'talos', variant: 'dark', theme: TALOS_DARK_DEFAULT })
...
export const THEME_DISPLAY_NAMES: Record<string, string> = (() => {
    const out: Record<string, string> = { talos: 'Talos', codex: 'Codex' }

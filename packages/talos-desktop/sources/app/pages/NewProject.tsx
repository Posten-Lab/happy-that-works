            ...
            <div className="new-project">
                <div className="new-project__panel">
                    ...
                    <p className="new-project__copy">
                        Talos opens chats and terminals inside a project workspace. Worktree projects create local git worktrees in the Talos workspace folder; plain projects create lightweight sections in the same folder.
                    </p>

...
- Mapping to Claude happens in `packages/talos-cli/src/claude/utils/permissionMode.ts`:
...
`packages/talos-app/sources/sync/storage.ts`
...
`packages/talos-app/sources/app/(app)/new/index.tsx`
`packages/talos-app/sources/components/NewSessionWizard.tsx`
...
`packages/talos-cli/src/claude/runClaude.ts`
`packages/talos-cli/src/claude/utils/permissionMode.ts`
...
`packages/talos-cli/src/claude/claudeLocal.ts`
